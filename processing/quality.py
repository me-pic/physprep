...
def sqi_eda(signal_eda, info, sampling_rate=10000):
    ...
    summary["Mean_rise_time"] = np.round(np.mean(info['SCR_RiseTime']), 4)
    summary["SD_rise_time"] = np.round(np.std(info['SCR_RiseTime']), 4)
    summary["Median_rise_time"] = np.round(np.median(info['SCR_RiseTime']), 4)
    summary["Min_rise_time"] = np.round(np.min(info['SCR_RiseTime']), 4)
    summary["Max_rise_time"] = np.round(np.max(info['SCR_RiseTime']), 4)
